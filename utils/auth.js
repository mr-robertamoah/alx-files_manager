 ...
 */
export const getUserWithAuthorization = async (req) => {
 ...
 * @returns {Promise<{_id: ObjectId, email: string, password: string}>}
 */
export const getUserWithToken = async (req) => {
...
export default {
  getUserWithAuthorization: async (req) => getUserWithAuthorization(req),
  getUserWithToken: async (req) => getUserWithToken(req),
};
